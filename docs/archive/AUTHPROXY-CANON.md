# AuthProxy Landing Canon

> Unified canonical content file for the AuthProxy one-page landing.
> Base: `authproxy-landing-cms-base.md`.
> Enriched with validated, landing-safe proof points from `LANDING-AUTHPROXY.md`.
